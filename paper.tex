...
\begin{abstract}
    ...
    for the purpose of historical DNS research. Based on the hypothesis that a big part of 
    the DNS remains unchanged between measurements, this research will create a delta-based
    storage system. This system would only store the changes compared to a snapshot instead of
    all daily retrieved data points to improve on storage efficiency. Furthermore, the research 
    would test different delta-based compression strategies to determine an optimal strategy 
    taking both storage and analysis efficiency into account.
\end{abstract}
...
\input{sections/methodologies.tex}
