...
%% article.
\begin{abstract}
    This paper demonstrates that a large part of the DNS remains unchanged on a daily basis.
    Furthermore, this paper introduces DeltaParq, a schema-aware delta-based generalized storage 
    system capable of exploiting repeated storage of identical data to store only what is necessary.
    An evaluation of the DeltaParq protype, over daily historical DNS data, is used to 
    demonstrate the impact of using delta-based compression on both storage and analysis efficiency.
\end{abstract}
...
During the preparation of this work the author used Claude Sonnet 4.6 in order to
