...
Since its introduction in 1983 as a small name system on the ARPANET, the Domain Name System (DNS) 
...
storage prototype built for the OpenINTEL project\footnote{\url{https://github.com/h0psej0ch/DeltaParq}}. An evaluation framework will be presented that assesses both storage 
